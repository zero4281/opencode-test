# Test Results: OmniCoder Qwen3.5 (9B 112k)
...
I had to tell it to \`write the script.\`

## Prompts that I had to run several times

Run \`python ./hf_search.py -a "Jackrong"\` and check it for errors.  Once the errors are identified, fix them.  Here's some relevant documentation: https://huggingface.co/docs/huggingface_hub/en/package_reference/hf_api.md
